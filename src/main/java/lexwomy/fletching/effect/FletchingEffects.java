...
//            new FocusEffect());
    public static final RegistryEntry<StatusEffect> FRENZY = Registry.registerReference(Registries.STATUS_EFFECT, Identifier.of(Fletching.MOD_ID, "frenzy"), new FrenzyEffect().addAttributeModifier(EntityAttributes.MOVEMENT_SPEED, Identifier.of(Fletching.MOD_ID, "frenzy"),
            0.02F, EntityAttributeModifier.Operation.ADD_MULTIPLIED_TOTAL));
    public static final RegistryEntry<StatusEffect> FOCUS = Registry.registerReference(Registries.STATUS_EFFECT, Identifier.of(Fletching.MOD_ID, "focus"), new FocusEffect());
